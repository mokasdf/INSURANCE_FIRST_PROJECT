...
namespace INSURANCE_FIRST_PROJECT.Controllers
{
    public class TestimonialsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,State,Message,Testimonialdate,Extra,Useraccountid")] Testimonial testimonial)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(decimal id, [Bind("Id,State,Message,Testimonialdate,Extra,Useraccountid")] Testimonial testimonial)
        {
